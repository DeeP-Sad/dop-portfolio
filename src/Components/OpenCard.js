...
const OpenCard = () => {
  return (
    <div className='bg-[#D9D9D9] rounded-lg overflow-auto'>
    ...
    <div className='flex-auto shrink h-36 mb-3 mt-5 px-4 mx-4 text-black'>
    <p className=' text-3xl'>
        Objectives
    </p>
    <p className=' text-sm ml-1 leading-7 mt-4 pb-5 font-normal font-sans'>
    <ul className=' list-disc'>
        <li>Develop a Rubik’s Cube Model (RCM) based
        ...
        <li>Study of protein-folding dynamics of spike glycoprotein with
            statistical energy landscape theory (SELT) based stochastic model.
        </li>
        <li>Compare the similarity and dissimilarity between SELT and RCM model
        ...
        <li>Calculation of the mean first-passage time (MFPT) using both SELT and 
            RCM model at different temperature. 
        </li>
        <li>Understand the thermodynamics of molecular interaction between spike 
